...
<body>
 ...
 <!-- ======= Header ======= -->
    ...
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo mr-auto"><a href="web-home">Xdplax</a></h1>
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          <li ><a href="web-home"><span>Home</span></a></li>
          <li class="active"><a href="terms"><span>Terms And Condition</span></a></li>
          <li class="drop-down"><a href="academy">What We Do</a>
            <ul>
              <li><a href="academy">Forex Academy</a></li>
     ...
     <a href="fxmint" class="get-started-btn"><strong> FxMinit</a>
...
<h4>Visitor Responsibility</h4>

The information on the Xdplax Int'l website is not intended for distribution to, or use by, any person in any country or jurisdiction where such distribution or use would be contrary to local law or regulation. It is the responsibility of every visitor to this website to ascertain the terms of and comply with any local law or regulation to which they are subject.<br><br>
...
Xdplax Int'l accepts no responsibility or liability of any kind in respect of any materials on any website or network that is not under our direct control. You acknowledge that your access to such other websites or networks via such a link may require us to provide certain information about you to the proprietor of that website or network.<br><br>

Nothing in this website is intended to be nor should it be understood by you as being investment advice from or by us.<br><br>

<h4>Third-Party Offerings</h4>

The Xdplax Int'l website may contain references to other special offers or promotions by persons who are not part of our group of companies. Subject to any applicable law that cannot be excluded, we make no warranties or representations regarding the quality, accuracy, or fitness for purpose of the goods or services available from these persons. Your obtaining of goods or services from these persons is at your own risk. You indemnify each member of our group of companies against all liability, loss, damage, cost and expense arising from or relating to your obtaining goods or services from a third party referred to on this website.<br><br>

<h4>Market Data</h4>

With respect to any market data or other information that we or any third-party service provider display on the Xdplax Int'l website, (a) such data is indicative only and we and any such provider are not responsible or liable if any such data or information is inaccurate or incomplete in any respect; (b) we and any such provider are not responsible or liable for any actions that you take or do not take based on such data or information; and (c) such data or information is proprietary to us and/or any such provider and you are not permitted to re-transmit, redistribute, publish, disclose or display in whole or in part such data or information to third parties except as may be required by any law or regulation.<br><br>

<h4>Privacy</h4>

Xdplax Int'l will comply with obligations imposed on us by applicable Data Protection legislation.<br><br>
...
<!-- ======= Footer ======= -->
  <footer id="footer">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="footer-info">
              <h3>Xdplax International</h3>
              <p class="pb-3"><strong>Customer Care Lines:</strong></p>
              <strong>Phone:</strong> +234 814 998 0459<br>
              <strong>Phone:</strong> +234 701 669 9756<br><br>
              <p>
                27 Edgerly Road <br>
                Calabar, Nigeria<br><br>
                <strong>Phone:</strong> +234 706 202 8958<br>
                <strong>Email:</strong> info@xdplaxInternational.com<br>
              </p>
          ...
          <div class="col-lg-2 col-md-6 footer-links">
            <h4>Useful Links</h4>
            <ul>
              <li><i class="bx bx-chevron-right"></i> <a href="web-home">Home</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#about"> About us</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#services">Services</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="terms">Terms of service</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="academy">Academy</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="software">Software Dev.</a></li>
            </ul>
          </div>
          ...
          <div class="col-lg-4 col-md-6 footer-newsletter">
            ...
            <p>Subscribe to recieve our newsletters anytime we send them, to stay informed.</p>
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span>Xdplax Int'l</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
        ...
        Designed by <a href="https://xdplaxinternational.com/">xdplax International</a>
      </div>
    </div>
  </footer><!-- End Footer -->
