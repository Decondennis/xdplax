...
<title>Commission-Paymemt</title>
...
<h1 class="h4 text-gray-900 mb-4">Pay Commission</h1>
</div>
        @if(session('message'))
        ...
        <div class="form-group">
            ...
            <input type="hidden" name="source" value="COM"/>
        ...
        FlutterwaveCheckout({
            ...
            callback: data =>{
                ...
                if(resp.status == 'successful'){
                    ...
                    window.location = '/fxmint-member-dashboard?status=ok';
                }
                else{
                    //payment failed
                    window.location = '/fxmint-member-dashboard?status=fail';
                }
            },
            onclose: ()=>{
